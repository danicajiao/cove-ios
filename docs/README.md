...
- **[Trust Layer Architecture](TRUST_LAYER_ARCHITECTURE.md)** - The product's core: brand/storefront/product entity model, the trust signal system, composite scoring, and the discovery query (direction doc — supersedes the product-centric model)
