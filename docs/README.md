...
- **[Category Taxonomy](CATEGORY_TAXONOMY.md)** - The full v1 category tree (~140 nodes across 9 top-level categories), design principles for tree nodes vs attributes, and the add/remove runbook
